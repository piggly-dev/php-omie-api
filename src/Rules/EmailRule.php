 ...
 */
class EmailRule implements RuleInterface, FixableInterface
{
	/**
	...
	public function assert(string $name, $value)
	{
		if (!Validator::email($value)) {
			throw new InvalidArgumentException(\sprintf('%s => O e-mail é inválido.', $name));
		}
	}
