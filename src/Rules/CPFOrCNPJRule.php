...
/**
 * Assert if value is a CPF or CNPJ.
 *
 ...
 */
class CPFOrCNPJRule implements RuleInterface, FixableInterface
{
	/**
	...
	{
		if (!Validator::cpfOrCnpj($value)) {
			throw new InvalidArgumentException(\sprintf('%s => O CPF/CNPJ é inválido.', $name));
		}
	}
